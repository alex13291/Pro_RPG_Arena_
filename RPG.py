...
RED =   (255,   0,   0)
fGreen = GREEN
weapons1 = ['zombie hand:4', 'small sword:5', 'daggers:6']# оружие 1 ранга
armor1 = ['wooden armor:2', 'plastic armor:3', 'chain armor:4']#броня 1 ранга
weapons2 = ['magic book:7', 'hook:8', 'knuckle:9']#оружие 2 ранга
armor2 = ['iron armor:5', 'magic water armor:6', 'ninja clothes:7']# броня 2 ранга
lvl = 0  # уровень
damage = 2 # урон
armor = 1# защита
life = 100 # жизни
